...
(function() {
    ...
    function getTabTextForCode(code_elt) {
        ...
        //NOTE: These are the additions to let ""```title" in the md docs be imported
        //to the name of each tab, rather than the type of code used.
        const tab_title = code_elt.classList;
        let get_val = tab_title.value;
        const cut_title = get_val.slice(9,-5);
        let tab_text = cut_title;
        //console.log(tab_text)
        return tab_text;
        //uncomment out the line below to restore original functionality.
